...
---
![Cloud Dataprep Pipeline](../assets/ut5-cloud-dataprep-pipeline.png)
*Pipeline ETL mostrando el flujo de datos desde importación (CSV, GCS, BigQuery) hasta Cloud Dataprep para exploración, limpieza y enriquecimiento, y finalmente a BigQuery para análisis, almacenamiento y reportes*
---
...
![Cloud Dataprep Merge Columns](../assets/ut5-cloud-dataprep-merge-columns.png)
*Interfaz de Cloud Dataprep mostrando el diálogo de "Merge columns" para combinar columnas (fullVisitorId y visitId) usando un separador, creando una nueva columna unique_session_id*
...
![Cloud Dataprep Suggestions](../assets/ut5-cloud-dataprep-suggestions.png)
*Panel de sugerencias de Cloud Dataprep detectando automáticamente valores faltantes en la columna totalTransactionRevenue y proponiendo acciones como eliminar filas, mantener filas, crear columnas o establecer valores por defecto*
...
### 2. **Visualización de Calidad de Datos en Tiempo Real**
